...
\subsubsection*{5 -- \textit{New Forms of Slavery and Injustice I} (9/24)}
\begin{itemize}
\item \textbf{Readings(s)}: 
%\newline Chapter 5 in \textit{Where Do We Go from Here?} -- King 
%\newline Chapter 6 in \textit{Where Do We Go from Here?} -- King 
\newline Introduction in \textit{The New Jim Crow} -- Alexander 
\item \textbf{Due}: 
...
\subsubsection*{6 -- \textit{New Forms of Slavery and Injustice II} (10/1)}
\begin{itemize}
\item \textbf{Readings(s)}: 
...
\subsubsection*{7 -- \textit{New Forms of Slavery and Injustice III} (10/8)}
\begin{itemize}
\item \textbf{Readings(s)}: 
...
\subsubsection*{8 -- \textit{New Forms of Slavery and Injustice IV} (10/15)}
\begin{itemize}
\item \textbf{Readings(s)}: 
...
\subsubsection*{9 -- \textit{New Forms of Slavery and Injustice V} (10/22)}
\begin{itemize}
\item \textbf{Readings(s)}: 
...
\subsubsection*{10 -- \textit{New Forms of Slavery and Injustice VI} (10/29)}
\begin{itemize}
\item \textbf{Readings(s)}: 
...
\subsubsection*{11 -- \textit{New Forms of Slavery and Injustice VII} (11/5)}
\begin{itemize}
\item \textbf{Readings(s)}: 
